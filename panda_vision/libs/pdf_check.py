...
#     """"
#     Détecte si le PDF contient des caractères invalides
#     """
#     '''pdfminer est plus lent, il faut d'abord échantillonner environ 10 pages'''
...
#     text = text.replace("\n", "")
#     # logger.info(text)
#     '''Les caractères illisibles extraits par pdfminer ont la caractéristique (cid:xxx)'''
...
#     '''Quand plus de 5% du texte est illisible, on considère le document comme corrompu'''
#     if cid_chars_radio > 0.05:
#         return False  # Document corrompu
#     else:
#         return True   # Document normal
